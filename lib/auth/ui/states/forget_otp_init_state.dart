...
class OtpForgotInitState extends States{
  final String? email;

  final VerificationOtpForgotScreenState screenState;
  String? errorMessage;
  OtpForgotInitState(this.email,this.screenState,this.errorMessage,);
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                        child: TextButton(
                          onPressed: () => {
                            screenState.Forgetpaswwww(GenOtpRequest(email, "pass"))
                          },
                          child: Text(
                            "RESEND",
                            style: TextStyle(
                ...
                Padding(
                  ...
                  child: CustomButton(
                    buttonTab: () {
                      ...
                      screenState.ConfForgotRequest(ConfOtpRequest(otptext.text, email,""));
                    },
