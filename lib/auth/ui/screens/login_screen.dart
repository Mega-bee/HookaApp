...
class _loginScreenState extends State<loginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Navigator.push(
    context,
    CustomPageRoute(child:DrawerScreen()));
...
//                                  builder: (context) =>  Navigationbar()));
                              ...
                              Center(child: Text("or login with",style: TextStyle(color: Colors.grey[500]),),),
                              SizedBox(height: mediaQueryHeight*0.02,),
...
elevation: 7,
                                    ...
                                    borderRadius: BorderRadius.circular(30.0),),
                                      child: Center(child: Image.asset("assets/images/1534129544.png",width: 25,)),
                                  ...
                                  Container(
                                    ...
                                    child: Card(
                                      ...
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(30.0),),
                                      child: Center(child: Icon(FontAwesomeIcons.facebookF,size: 25,color: Colors.blue[900],)),
                              ...
                              Row(
                                  ...
                                  children:[ Text("Don't have an account? ",style: TextStyle(color: Colors.grey),),
                                TextButton(child:Text("SIGN UP",style: TextStyle(fontWeight: FontWeight.bold),),
