...
import '../auth/otp_module.dart' as _i14;
...
import '../auth/ui/screens/otp_screen.dart' as _i9;
...
import '../splash_screen/ui/splash_screen.dart' as _i10;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i9.PinCodeVerificationScreen>(
      () => _i9.PinCodeVerificationScreen(phoneNumber: get<String>()));
  gh.factory<_i10.SplashScreen>(() => _i10.SplashScreen());
  ...
  gh.factory<_i13.LoginRepository>(() =>
      _i13.LoginRepository(get<_i11.ApiClient>(), get<_i5.AuthService>()));
  gh.factory<_i14.OtpModule>(
      () => _i14.OtpModule(get<_i9.PinCodeVerificationScreen>()));
  gh.factory<_i15.SignUpCubit>(
      () => _i15.SignUpCubit(get<_i13.LoginRepository>()));
  gh.factory<_i16.SignupScreen>(
      () => _i16.SignupScreen(cubit: get<_i15.SignUpCubit>()));
  gh.factory<_i17.SplashModule>(
      () => _i17.SplashModule(get<_i10.SplashScreen>()));
