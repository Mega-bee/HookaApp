        ...
        child: Column(
          children: [
                      ...
                      Wrap(
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                                child:
                                Text("No Interest yet..", style: TextStyle(
                                    color: Colors.black),)),
                          ) :
                          Container(
                            width: 80,
                            ...
                            child: Center(
                                child:
                                Text(_profileResponse.interests.toString(),
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    _profileResponse.experience == null ||
                        _profileResponse.experience!.isEmpty ? Column(
                      children: [
                        SizedBox(height: 10,),
                        Align(
            ...
            Padding(
              ...
              child: Container(
                color: Colors.white,
                child: _profileResponse.experience == null ||
                    _profileResponse.experience!.isEmpty ? Align(
                ...
                Column(
                    ...
                    children: [
                      ...
                      Container(
                        height: 220,
                        child:
                        _profileResponse.education == null ||
                            _profileResponse.education!.isEmpty ? Text(
                            "No Experiences yet..") :
                        GridView.builder(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: _profileResponse.addresses == null ||
                    _profileResponse.addresses!.isEmpty ? Align(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 25,),
                        child: Text("No Addresses..", style: TextStyle(
                            color: Colors.black,
                            fontWeight: FontWeight.bold,
                            fontSize: 10),
                        ),)
