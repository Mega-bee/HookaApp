                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  widget.modelp!.cuisine.toString(),
                                  style: GoogleFonts.anekLatin(
                                      color: Colors.black),
                                ),
                                Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      widget.isFavFunc!(isFavv);
                                      isFavv = !isFavv;
                                      setState(() {});
                                    },
                                    child: isFavv != widget.modelp!.isInFavorite
                                        ? Icon(
                                            Icons.favorite,
                                            size: 27,
